...
contract RICKS is ERC20, ERC721Holder {
    ...
    /// @notice the minimum length of auctions
    ...
    function startAuction() external payable {
        ...
        // Dutched-RICKS
        // [Set highest possible price for this RICKS]
        // Price decays, if not bought defaults to previous owner
    ...
    /// @notice an external function to buy RICKS in auction before the timer runs out.
    function buy() external payable {
        ...
        uint256 elapsedTime = auctionLength - (auctionEndTime - block.timestamp);

        currentPrice = currentPrice - ((currentPrice * elapsedTime) / auctionLength);
